...
public class ProcessingItem extends AbstractProcessingItem implements TopologyNode, Serializable {
    private static final long serialVersionUID = -9066409791668954099L;
    private Set<GearpumpStream> streams;

    public ProcessingItem(Processor processor, int parallelism) {
    ...
    @Override
    protected org.apache.samoa.topology.ProcessingItem addInputStream(Stream inputStream, PartitioningScheme scheme) {
